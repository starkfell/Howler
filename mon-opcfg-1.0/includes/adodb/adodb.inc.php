...
*/
	...
	*/
	...
	function &Execute($sql,$inputarr=false) 
	{
		...
		if ( !preg_match('/^INSERT INTO history/', $sql) && !preg_match('/^SELECT/i', $sql)) {
			$username = $_SERVER["PHP_AUTH_USER"];
			$t_sql = preg_replace('/\'/', '/"/', $t_sql);
			$t_ret =& $this->Execute("INSERT INTO history ( username, query, ctime) values ( '$username', '$t_sql', NOW() )");
		}
