...
#
# Plugin: icinga_check_port
#
# Last Modified By: [R. Irujo]
# Last Modified:    05.17.2012
#
#
# [Process State] - Returns back a value of "1" if the Network Port is available and a "0" if it is not.
#
$opt[1] = "--vertical-label \"$UNIT[1]\" --title \"Port State - $hostname / $servicedesc\" ";
...
$def[1] .= rrd::gradient("var1", "EEC900", "EEEE00", "$NAME[1]");
