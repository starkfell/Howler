 ...
 * 
 *
 * Last Modified:              06.11.2012 - [R. Irujo]
 *                             Changed the 'Open a Connection' section error return value(s) from
 *                             STATE_CRITICAL to STATE_UNKNOWN.
 *
 *
 ***************************************************************************************************/
...
int my_connect(char *host_name,int port,int *sd,char *proto){
	...
	*sd=socket(PF_INET,(!strcmp(proto,"udp"))?SOCK_DGRAM:SOCK_STREAM,ptrp->p_proto);
	...
	/* open a connection */
        /* [R. Irujo] - 06.11.2012 - Changed the STATE_CRITICAL to STATE_UNKNOWN to cut down on false positive alerts. */
